...
contract UfundraiserTest is Test {
    Ufundraiser public registry;
    ...
    function testCannotRegisterDuplicateName() public {
        ...
        vm.prank(user2);
        vm.expectRevert(Ufundraiser.NameAlreadyRegistered.selector);
        registry.registerName("alice");
    }
    ...
    function testCannotTransferUnownedName() public {
        ...
        vm.prank(user2);
        vm.expectRevert(Ufundraiser.NotNameOwner.selector);
        registry.transferName("alice", user2);
    }
    ...
    function testInvalidNameLength() public {
        vm.prank(user1);
        vm.expectRevert(Ufundraiser.InvalidName.selector);
